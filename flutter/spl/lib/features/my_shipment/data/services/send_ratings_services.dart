...
class SendRatingsServices {
  final Dio dio;
  SendRatingsServices({required this.dio}) {
  ...
  Future<Either<Failures, Response>> postRatingsServices({
    ...
    try {
      final response = await dio.post(
        '/ratings',
        data: {'parcelId': parcelId, 'rate': rate, 'comment': comment},
      );
