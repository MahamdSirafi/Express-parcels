...
class CustomServiceCenterViewBody extends StatefulWidget {
  const CustomServiceCenterViewBody({super.key});

  @override
  State<CustomServiceCenterViewBody> createState() =>
      _CustomServiceCenterViewBodyState();
}

class _CustomServiceCenterViewBodyState
    extends State<CustomServiceCenterViewBody> {
