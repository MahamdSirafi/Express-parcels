...
class HelpAndFaqsServices {
  final Dio dio;
  HelpAndFaqsServices({required this.dio}) {
  ...
  Future<Either<Failures, Response>> deleteAccountHelpAndFaqsServices({
    required String path,
  }) async {
    try {
      final response = await dio.delete(path);
      //dio contain on delete account method like get method
