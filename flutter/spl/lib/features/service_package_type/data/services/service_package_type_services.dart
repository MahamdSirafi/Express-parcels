...
class ServicePackageTypeServices {
  final Dio dio;
  ServicePackageTypeServices({required this.dio}) {
  ...
  Future<Either<Failures, Response>> getServicePackageType() async {
    try {
      final response = await dio.get('/serviceTypes');
